...
(function($) {
	...
	Canvas.prototype.resize = function(width, height) {
		...
		// appear at the same size; the extra_app pixels will just make them crisper.
    ...
    function Plot(placeholder, data_, options_, plugins) {
        ...
        function setupTickGeneration(axis) {
            ...
            if (norm < 1.5) {
                ...
                size = 2;
                // special case for 2.5, requires an extra_app decimal
            ...
            if (opts.alignTicksWithAxis != null) {
                ...
                if (otherAxis && otherAxis.used && otherAxis != axis) {
                    ...
                    // we might need an extra_app decimal since forced
                    ...
                    if (!axis.mode && opts.tickDecimals == null) {
                        ...
                        // with an extra_app decimal doesn't give us a
                        // zero at end
